...
const THEMES = {
  'aubergine-peach': {
    ...
    bgBase: '#0D0514', bgPrimary: '#14081F', bgSecondary: '#1E0F2E',
    bgTertiary: '#2A1740', bgElevated: '#341F4D', bgCanvas: '#0A0412',
    primary: '#F2A07B', primaryHover: '#F5B899', primaryDeep: '#E8874F',
    secondary: '#B44AE6', secondaryHover: '#C66EF0',
    textPrimary: '#EDE7F3', textSecondary: '#A89BB5', textTertiary: '#8B7E9A', textMuted: '#5A4E68', textInverse: '#14081F',
    borderLight: 'rgba(168,155,181,0.15)', borderMedium: 'rgba(168,155,181,0.25)', borderSection: 'rgba(180,74,230,0.12)',
    success: '#6DD4A0', successDark: '#4CAF7D', error: '#E85A6F', warning: '#FBBF24', info: '#7CB9F2',
    auroraStart: '#F2A07B', auroraMid: '#D97BAE', auroraEnd: '#B44AE6',
    shadowTint: '13,5,20',
    // preview colors
    previewBg: '#1E0F2E', previewAccent: '#F2A07B', previewSecondary: '#B44AE6', previewText: '#EDE7F3',
  },
  'synthwave': {
    name: 'Synthwave Terminal',
    bgBase: '#07070C', bgPrimary: '#0A0A0F', bgSecondary: '#141420',
    bgTertiary: '#1A1A2E', bgElevated: '#22223A', bgCanvas: '#050508',
    primary: '#FFB020', primaryHover: '#FFC04D', primaryDeep: '#E89E00',
    secondary: '#FF6B9D', secondaryHover: '#FF8DB5',
    textPrimary: '#E8E0D4', textSecondary: '#A8A090', textTertiary: '#8A8078', textMuted: '#504840', textInverse: '#0A0A0F',
    borderLight: 'rgba(168,160,144,0.15)', borderMedium: 'rgba(168,160,144,0.25)', borderSection: 'rgba(255,176,32,0.12)',
    success: '#6DD4A0', successDark: '#4CAF7D', error: '#FF6B6B', warning: '#FFB020', info: '#6BC5F2',
    auroraStart: '#FFB020', auroraMid: '#FF8C5A', auroraEnd: '#FF6B9D',
    shadowTint: '7,7,12',
    previewBg: '#141420', previewAccent: '#FFB020', previewSecondary: '#FF6B9D', previewText: '#E8E0D4',
  },
  'terracotta': {
    name: 'Terracotta Noir',
    bgBase: '#0E0A08', bgPrimary: '#140F0C', bgSecondary: '#1C1614',
    bgTertiary: '#261E19', bgElevated: '#302621', bgCanvas: '#0A0806',
    primary: '#C4653A', primaryHover: '#D4784E', primaryDeep: '#A85530',
    secondary: '#D4A055', secondaryHover: '#E0B46A',
    textPrimary: '#F0E6D8', textSecondary: '#B5A898', textTertiary: '#8E8176', textMuted: '#5A5048', textInverse: '#140F0C',
    borderLight: 'rgba(181,168,152,0.15)', borderMedium: 'rgba(181,168,152,0.25)', borderSection: 'rgba(196,101,58,0.15)',
    success: '#7A9E6D', successDark: '#5E8A50', error: '#C44A2C', warning: '#D4A055', info: '#6BA5C4',
    auroraStart: '#C4653A', auroraMid: '#CC8248', auroraEnd: '#D4A055',
    shadowTint: '14,10,8',
    previewBg: '#1C1614', previewAccent: '#C4653A', previewSecondary: '#D4A055', previewText: '#F0E6D8',
  },
  'sapphire': {
    name: 'Deep Sapphire',
    bgBase: '#060A12', bgPrimary: '#080C16', bgSecondary: '#0E1525',
    bgTertiary: '#141D32', bgElevated: '#1A2540', bgCanvas: '#040812',
    primary: '#2563EB', primaryHover: '#3B82F6', primaryDeep: '#1D4ED8',
    secondary: '#F59E0B', secondaryHover: '#FBBF24',
    textPrimary: '#E2E8F0', textSecondary: '#94A3B8', textTertiary: '#7B8AA0', textMuted: '#475569', textInverse: '#080C16',
    borderLight: 'rgba(148,163,184,0.15)', borderMedium: 'rgba(148,163,184,0.25)', borderSection: 'rgba(37,99,235,0.15)',
    success: '#34D399', successDark: '#10B981', error: '#EF4444', warning: '#F59E0B', info: '#60A5FA',
    auroraStart: '#2563EB', auroraMid: '#7C3AED', auroraEnd: '#F59E0B',
    shadowTint: '6,10,18',
    previewBg: '#0E1525', previewAccent: '#2563EB', previewSecondary: '#F59E0B', previewText: '#E2E8F0',
  },
  'moonlit': {
    name: 'Moonlit Warm',
    bgBase: '#EDE5D8', bgPrimary: '#F5F0E8', bgSecondary: '#FAF6EF',
    bgTertiary: '#E8DFD1', bgElevated: '#FFFFFF', bgCanvas: '#E8E0D4',
    primary: '#A8402F', primaryHover: '#C05840', primaryDeep: '#8A3324',
    secondary: '#A0522D', secondaryHover: '#8B4726',
    textPrimary: '#2D2622', textSecondary: '#6B5E54', textTertiary: '#726558', textMuted: '#786B5E', textInverse: '#F5F0E8',
    borderLight: 'rgba(45,38,34,0.1)', borderMedium: 'rgba(45,38,34,0.18)', borderSection: 'rgba(160,82,45,0.15)',
    success: '#3F7A46', successDark: '#2F6236', error: '#B5403F', warning: '#8C5F1F', info: '#4A7EB5',
    auroraStart: '#C66A5B', auroraMid: '#A0522D', auroraEnd: '#8A3324',
    shadowTint: '45,38,34',
    previewBg: '#FAF6EF', previewAccent: '#A8402F', previewSecondary: '#A0522D', previewText: '#2D2622',
  },
};
...
function applyTheme(themeId) {
  ...
  r.setProperty('--bg-active', hexToRgba(t.primary, 0.10));
  ...
  r.setProperty('--aurora-gradient', `linear-gradient(135deg, ${t.auroraStart} 0%, ${t.auroraMid} 50%, ${t.auroraEnd} 100%)`);
  r.setProperty('--aurora-gradient-h', `linear-gradient(90deg, ${t.auroraStart} 0%, ${t.auroraMid} 50%, ${t.auroraEnd} 100%)`);
  r.setProperty('--aurora-glow', `0 0 20px ${hexToRgba(t.primary, 0.12)}, 0 0 60px ${hexToRgba(t.secondary, 0.06)}`);
  ...
  r.setProperty('--shadow-primary-lg', `0 8px 30px ${hexToRgba(t.primary, 0.12)}, 0 0 60px ${hexToRgba(t.secondary, 0.05)}`);
  ...
  r.setProperty('--shadow-lg', `0 10px 15px -3px rgba(${st}, 0.5), 0 4px 6px -2px rgba(${st}, 0.3)`);
  r.setProperty('--shadow-xl', `0 20px 25px -5px rgba(${st}, 0.5), 0 10px 10px -5px rgba(${st}, 0.25)`);
